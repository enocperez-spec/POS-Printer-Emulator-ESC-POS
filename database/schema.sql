...
VALUES
    ...
    ('v0.3.19', 'v0.3.19', 'Release', 'Printer profiles', 'Next', 319, 'Model differences between printer configurations explicitly.', 'Built-in and custom profiles for paper width, dots, code pages, fonts, cutter, drawer, images, barcode/QR features, status behavior, import, and export.', 'Profiles define behavior before multiple endpoints depend on it.', 'One capture replayed against two profiles shows deterministic expected capability and rendering differences.', NULL),
    ('v0.3.20', 'v0.3.20', 'Release', 'Multiple printer listeners', 'Planned', 320, 'Emulate multiple receipt printers from one computer.', 'Independent listener names, ports, addresses, profiles, state, counters, filtering, conflict detection, firewall setup, and fault isolation.', 'Multiple listeners reuse the profile model and enable multi-station testing.', 'Two simultaneous listeners receive jobs, apply different profiles, restart safely, and remain independently controllable.', NULL),
