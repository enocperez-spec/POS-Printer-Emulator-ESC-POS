...
VALUES
    ...
    ('v0.3.00', 'v0.3.00', 'Release', 'Trial and Full licensing', 'Released', 300, 'Add commercial Trial and Full editions.', 'Offline signed activation, installer registration, Full history, exports, and in-app activation.', 'Enable product evaluation and paid upgrades.', 'Trial and Full licensing were publicly released.', UTC_TIMESTAMP(6)),
    ...
    ('v0.3.16', 'v0.3.16', 'Release', 'Printer profiles', 'Next', 316, 'Model differences between printer configurations explicitly.', 'Built-in and custom profiles for paper width, dots, code pages, fonts, cutter, drawer, images, barcode/QR features, status behavior, import, and export.', 'Profiles define behavior before multiple endpoints depend on it.', 'One capture replayed against two profiles shows deterministic expected capability and rendering differences.', NULL),
    ('v0.3.17', 'v0.3.17', 'Release', 'Multiple printer listeners', 'Planned', 317, 'Emulate multiple receipt printers from one computer.', 'Independent listener names, ports, addresses, profiles, state, counters, filtering, conflict detection, firewall setup, and fault isolation.', 'Multiple listeners reuse the profile model and enable multi-station testing.', 'Two simultaneous listeners receive jobs, apply different profiles, restart safely, and remain independently controllable.', NULL),
    ('v0.3.18', 'v0.3.18', 'Release', 'Receipt comparison and automated validation', 'Planned', 318, 'Provide repeatable compatibility and regression testing.', 'Compare bytes, commands, text, warnings, and rendered output, with saved baselines, ignored dynamic fields, validation suites, and HTML, PDF, and JSON results.', 'Deterministic captures and profiles are required for meaningful comparisons.', 'Known-good captures pass, intentional changes fail precisely, and ignored dynamic fields avoid false failures.', NULL),
    ('v0.3.19', 'v0.3.19', 'Release', 'Enhanced support and connection diagnostics', 'Planned', 319, 'Guide nontechnical customers through connection problems and support collection.', 'Test the service, listeners, ports, firewall, queues, drivers, viewer, and local and remote connectivity, then create redacted reviewed support packages and offer repair actions.', 'Diagnostics should understand the completed listener, profile, capture, and comparison system.', 'Common connection problems are explained without Windows admin tools and a reviewed redacted support package can be produced.', NULL),
