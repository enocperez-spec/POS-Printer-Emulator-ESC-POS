...
SET status = 'Released',
    ...
    completion_criteria = 'Paid activation survives upgrade and maintenance reinstall, Trial can export activation diagnostics, a second Enterprise printer receives a test job on the first free port, and all 98 tests pass.',
    completed_at = COALESCE(completed_at, '2026-07-19 00:00:00.000000')
