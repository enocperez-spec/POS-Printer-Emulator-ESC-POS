...
<head>
  ...
  <title>Buy POS Printer Emulator — Pro Version</title>
...
<main>
  <section class="hero">
    ...
    <aside class="checkout" id="checkout">
      <span class="full-pill">Pro Version</span><h2>Permanent desktop license</h2>
  ...
  <section class="features"><div><p class="eyebrow">Pro Version</p><h2>Everything you need to test without limits.</h2></div><div class="feature-list"><article><span>∞</span><div><h3>Unlimited emulated print jobs</h3><p>Test as often as the job requires—no daily cap.</p></div></article><article><span>↺</span><div><h3>Full print-job history</h3><p>Return to prior receipts and diagnostics stored locally.</p></div></article><article><span>✓</span><div><h3>Clean receipt previews</h3><p>Remove the TRIAL watermark from the receipt viewer.</p></div></article><article><span>+</span><div><h3>All premium features</h3><p>Unlock exports and every current Pro Version capability.</p></div></article></div></section>
