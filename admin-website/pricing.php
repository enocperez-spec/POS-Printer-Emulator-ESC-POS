...
<aside class="sidebar"><nav><a href="/"><span aria-hidden="true">▥</span>Dashboard</a><a href="/#installations"><span aria-hidden="true">□</span>Installations</a><a href="/licenses.php"><span aria-hidden="true">◇</span>License Manager</a><a href="/orders.php"><span aria-hidden="true">▤</span>Purchase Orders</a><a class="active" href="/pricing.php"><span aria-hidden="true">$</span>Purchase Pricing</a></nav><p>Changes apply to new PayPal orders immediately.</p></aside>
<main class="pricing-main"><div class="page-heading"><div><h1>Purchase Pricing</h1><p>Manage the one-time Full Version price displayed at buy.posprinteremulator.com.</p></div></div>
