...
<title>License &amp; Usage | POS Printer Emulator</title><link rel="icon" type="image/png" href="assets/favicon.png"><link rel="stylesheet" href="assets/admin.css?v=20260714-2"><link rel="stylesheet" href="assets/admin-overrides.css?v=20260715-impact"><link rel="stylesheet" href="assets/mobile-nav.css?v=20260715-1"></head>
...
<article class="full"><svg class="metric-icon" viewBox="0 0 48 48" aria-hidden="true"><path d="M11 5h18l9 9v11M29 5v10h9M16 24h10M16 31h7"/><circle cx="35" cy="35" r="9"/><path d="m31 35 3 3 6-7"/></svg><div><span>Active paid licenses</span><strong><?= $metric(($summary['pro_licenses'] ?? 0) + ($summary['enterprise_licenses'] ?? 0)) ?></strong></div></article>
...
<article class="distribution"><h2>License distribution</h2><div class="donut-wrap"><div class="donut <?= (int)($summary['installations'] ?? 0) === 0 ? 'empty' : '' ?>" style="--full: <?= (int)($summary['installations'] ?? 0) > 0 ? round((((int)$summary['pro_licenses'] + (int)$summary['enterprise_licenses']) / (int)$summary['installations']) * 100, 2) : 0 ?>%"><div><strong><?= $metric($summary['installations'] ?? 0) ?></strong><span>installations</span></div></div><ul><li><i class="full-dot"></i><span>Pro</span><strong><?= $metric($summary['pro_licenses'] ?? 0) ?></strong></li><li><i class="full-dot"></i><span>Enterprise</span><strong><?= $metric($summary['enterprise_licenses'] ?? 0) ?></strong></li><li><i class="trial-dot"></i><span>Trial</span><strong><?= $metric($summary['trials'] ?? 0) ?></strong></li></ul></div></article></section>
<section class="table-panel" id="installations"><div class="table-toolbar"><h2>Installations</h2><div><label class="search"><span aria-hidden="true">⌕</span><input id="customer-search" type="search" placeholder="Search customers"></label><label><span class="sr-only">License filter</span><select id="license-filter"><option value="all">All licenses</option><option value="Enterprise">Enterprise</option><option value="Pro">Pro</option><option value="Trial">Trial</option></select></label></div></div><div class="table-scroll"><table><thead><tr><th>Company</th><th>Email</th><th>Version</th><th>License</th><th>Last seen (UTC)</th><th>Launches</th><th>Print jobs</th></tr></thead><tbody id="installation-rows">
